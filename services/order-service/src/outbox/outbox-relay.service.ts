...
export class OutboxRelayService implements OnModuleInit, OnModuleDestroy {
  ...
  private async poll() {
    try {
      ...
      // SELECT ... WHERE status='PENDING' ORDER BY createdAt LIMIT N
      // Lưu ý: Không dùng pessimistic lock vì ngoài transaction sẽ lỗi
   ...
   * Keeps the outbox table small for efficient polling.
   */
